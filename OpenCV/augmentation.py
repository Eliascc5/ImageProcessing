...
images_path= cwd +'/Imagettes_Acier_605MT26T_x100/' #path to original images
masks_path = cwd +'/mask/'
img_augmented_path=cwd +'/img_aug/' # path to store aumented images
msk_augmented_path=cwd +'/mask_aug/' # path to store aumented images
